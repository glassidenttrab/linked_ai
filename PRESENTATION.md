...
**Linked Ai 의 선택**: **로컬 우선 + 작은 모델 + 똑똑한 orchestration**.  
= 능력 격차를 **시스템 설계로 보완**.
...
└───────────────┬───────────────────────────────────────┘
                ↓ 자연어 명령
┌───────────────────────────────────────────────────────┐
│   Linked Ai (Anti-Gravity · VS Code Extension)       │
├───────────────────────────────────────────────────────┤
...
ACT 1: 와이파이 끊기
  ...
  📡 Wi-Fi OFF →
  사이드바: "안녕"
  →  Linked Ai: "사장님, 안녕하세요. 무엇을 도와드릴까요?"
...
**Linked Ai 방식** — *"Verified code as inventory"*:
...
| 기능 | ChatGPT Plus | Claude Code | **Linked Ai** |
|---|---|---|---|
| 가격 | $20/월 | $200/월 | **무료** |
| 로컬 LLM | ❌ | ❌ | ✅ |
| 오프라인 | ❌ | ❌ | ✅ |
...
*v1 — 2026.05.12 · Linked Ai v2.89.153*
