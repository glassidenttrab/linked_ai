...
## 📚 C-2. "Linked Ai 의 환각 방어 3중 시스템"

**큰 질문:** "Linked Ai 는 어떻게 작은 LLM 으로 정확한 매출을 답할까?"
...
## 📚 C-3. "RAG (Retrieval Augmented Generation) — Linked Ai 두뇌"
...
**문제:**
```
창 1: Linked Ai 활성화 → Bridge :4825 점유
창 2: Linked Ai 활성화 시도 → "EADDRINUSE" 충돌
...
## 📚 F-2. "AGI 가 오면? — Linked Ai 의 적응 전략"

**큰 질문:** "5년 후 AI 가 모든 걸 할 수 있으면 Linked Ai 가 필요해?"
...
*v1 — 2026.05.12 · Linked Ai v2.89.154*
